...
String strQuery = "SELECT COUNT(*) FROM record";
...
String strQuery1 = "SELECT COUNT(*) FROM record where status=discharged";
ResultSet rs1= st1.executeQuery(strQuery1);
String Countrow1="";
while(rs1.next()){
Countrow1 = rs1.getString(1);
out.println("Total REcovered PATIENTS :" +Countrow1);
}
