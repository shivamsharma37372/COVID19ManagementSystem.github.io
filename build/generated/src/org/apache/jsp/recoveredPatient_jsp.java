...
public final class recoveredPatient_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/link7.html");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\n");
      out.write("\t\t\t<TD align=\"right\" width=\"33%\"><FONT SIZE=\"4\" COLOR=\"#FFFFFF\"><B>VISITOR PANEL</B></FONT></TD>\n");
      out.write("\t\t</TR>\n");
      out.write("\t</TABLE>\n");
      out.write("\t<TABLE align=\"center\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\">\n");
      ...
      out.write("\n");
      out.write("<div class=\"dropdown\">  \n");
      out.write("  <button class=\"dropbtn\">BACK</button>\n");
      out.write("  <div class=\"dropdown-content\">\n");
      out.write("    <a href=\"visitor.jsp\">BACK </a>    \n");
      out.write("  </div>  \n");
      out.write("</div>\n");
      out.write("    \n");
      out.write("</body>\n");
...
String strQuery = "SELECT COUNT(status) FROM record where status=recovered ";
ResultSet rs = st.executeQuery(strQuery);
String Countrow="";
while(rs.next()){
Countrow = rs.getString(1);
out.println("Recovered PATIENTS :" +Countrow);
}
}
